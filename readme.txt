...
* Fix - The tag Icon can not be changed in single listing (Issue #1270)
...
* Fix - Select2 toggle icon issue
* Improve - Too many requests to map autosuggest API (PR #1320)
* Fix - Compatibility issue with Elementor Plugin
* Fix - PHP warning issue in listing REST controller
* Fix - Location detector click issue after category selection in search form
